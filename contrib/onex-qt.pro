...
RESOURCES += src/qt/onex.qrc src/qt/onex_locale.qrc

TRANSLATIONS += src/qt/locale/onex_bg.ts \
                src/qt/locale/onex_de.ts \
                src/qt/locale/onex_en.ts \
                src/qt/locale/onex_es.ts \
                src/qt/locale/onex_fi.ts \
                src/qt/locale/onex_fr.ts \
                src/qt/locale/onex_it.ts \
                src/qt/locale/onex_ja.ts \
                src/qt/locale/onex_pl.ts \
                src/qt/locale/onex_pt.ts \
                src/qt/locale/onex_ru.ts \
                src/qt/locale/onex_sk.ts \
                src/qt/locale/onex_sv.ts \
                src/qt/locale/onex_vi.ts \
                src/qt/locale/onex_zh_CN.ts \
                src/qt/locale/onex_zh_TW.ts
