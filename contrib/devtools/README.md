...
Setup
---------
Configuring the github-merge tool for the ONEX repository is done in the following way:

    git config githubmerge.repository onex/onex
...
A script to optimize png files in the ONEX
