...
#   c) node1 mines 32 blocks, so now node 0 has 500000ONEX, node 1 has 4250ONEX, node2 has none.
#   d) node0 sends 601 ONEX to node2, in two transactions (301 ONEX, then 300 ONEX).
