...
The ONEX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ONEX Core project, and is not to be
confused with overall ONEX Network Protocol consensus changes.

Whether a pull request is merged into ONEX Core rests with the project merge
...
Patches that change ONEX consensus rules are considerably more involved than
...
Where a patch set proposes to change the ONEX consensus, it must have been
