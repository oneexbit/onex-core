/* src/config/onex-config.h.  Generated from onex-config.h.in by configure.  */
/* src/config/onex-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ONEX_CONFIG_H

#define ONEX_CONFIG_H
...
#define PACKAGE_NAME "ONEX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ONEX Core 2.2.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "onex"
