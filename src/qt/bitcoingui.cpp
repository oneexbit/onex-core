...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ONEX Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ONEX"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the ONEX Core help message to get a list with possible ONEX command-line options"));
