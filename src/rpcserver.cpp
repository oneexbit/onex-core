...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ONEX features */
        {"ONEX", "masternode", &masternode, true, true, false},
        {"ONEX", "listmasternodes", &listmasternodes, true, true, false},
        {"ONEX", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ONEX", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ONEX", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ONEX", "masternodedebug", &masternodedebug, true, true, false},
        {"ONEX", "startmasternode", &startmasternode, true, true, false},
        {"ONEX", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ONEX", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ONEX", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ONEX", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ONEX", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ONEX", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ONEX", "mnbudget", &mnbudget, true, true, false},
        {"ONEX", "preparebudget", &preparebudget, true, true, false},
        {"ONEX", "submitbudget", &submitbudget, true, true, false},
        {"ONEX", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ONEX", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ONEX", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ONEX", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ONEX", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ONEX", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ONEX", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ONEX", "checkbudgets", &checkbudgets, true, true, false},
        {"ONEX", "mnsync", &mnsync, true, true, false},
        {"ONEX", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
